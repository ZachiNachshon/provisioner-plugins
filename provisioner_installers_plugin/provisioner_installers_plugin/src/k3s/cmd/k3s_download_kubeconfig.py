...
from provisioner_installers_plugin.src.k3s.cmd.remote_k3s_download_kubeconfig import (
    RemoteK3sKubeConfigDownloadArgs,
    RemoteK3sKubeConfigDownloadRunner,
)
...
class K3sKubeConfigDownloadCmdArgs:
    ...
    def __init__(self, remote_opts: RemoteOpts = None, dest_file_path: str = None, server_url: str = None) -> None:
