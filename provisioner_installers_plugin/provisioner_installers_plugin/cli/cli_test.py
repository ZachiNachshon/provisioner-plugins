...
#         Assertion.expect_call_arguments(self, run_call, arg_name="args", assertion_callable=lambda args: self.assertIn("anchor", args.utilities))

#         helm()
#         Assertion.expect_exists(self, run_call, arg_name="ctx")
#         Assertion.expect_call_arguments(self, run_call, arg_name="args", assertion_callable=lambda args: self.assertIn("helm", args.utilities))

#         k3s_server()
#         Assertion.expect_exists(self, run_call, arg_name="ctx")
#         Assertion.expect_call_arguments(self, run_call, arg_name="args", assertion_callable=lambda args: self.assertIn("k3s-server", args.utilities))

#         k3s_agent()        
#         Assertion.expect_exists(self, run_call, arg_name="ctx")
#         Assertion.expect_call_arguments(self, run_call, arg_name="args", assertion_callable=lambda args: self.assertIn("k3s-agent", args.utilities))
...
#             method_to_run=lambda: TestCliRunner.run(UtilityInstallerCliTestShould.create_local_utility_installer_runner),
#         )
...
#             "repo": "anchor",
#             "supported_releases": {
#               "darwin_amd64": "anchor_{}_darwin_amd64.tar.gz",
#               "darwin_arm64": "anchor_{}_darwin_arm64.tar.gz",
#               "linux_amd64": "anchor_{}_linux_amd64.tar.gz",
#               "linux_arm": "anchor_{}_linux_armv6.tar.gz",
#               "linux_arm64": "anchor_{}_linux_arm64.tar.gz"
#             },
...
#             ],
#             method_to_run=lambda: TestCliRunner.run(UtilityInstallerCliTestShould.create_remote_utility_installer_runner),
#         )